...
// }) {
//   // Await params terlebih dahulu jika menggunakan Next.js versi terbaru
...
//     return (
//       <div data-theme={userTheme} className="min-h-screen bg-base-100 transition-colors duration-300">
//         <div className="flex flex-col items-center justify-start pt-20 md:pt-10 pb-4 p-4">
//           <div className="w-full max-w-lg mx-auto md:relative md:bg-base-300 md:rounded-3xl md:p-20 md:border md:border-base-100 shadow-sm">
//             {children}
//           </div>
//         </div>
//       </div>
//     );
//   } catch (error) {
//     // Jika user tidak ditemukan, tetap tampilkan layout dengan tema light
